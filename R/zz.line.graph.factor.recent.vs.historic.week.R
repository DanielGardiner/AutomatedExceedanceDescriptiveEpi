...
for(i in 1:nrow(factors.df)){
  ...
  plot.name = paste0("line.graph.", as.character(i$name1), ".recent.vs.historic.week")
...
# line.graph.all.recent.vs.historic.week
# line.graph.sex.recent.vs.historic.week
# line.graph.age.grp.recent.vs.historic.week
# line.graph.request.recent.vs.historic.week
# line.graph.spectype.recent.vs.historic.week
