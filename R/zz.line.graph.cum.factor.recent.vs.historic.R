...
for(i in 1:nrow(factors.df)){
  ...
  plot.name = paste0("line.graph.cum.", as.character(i$name1), ".recent.vs.historic")
...
# line.graph.cum.age.grp.recent.vs.historic
# line.graph.cum.request.recent.vs.historic
# line.graph.cum.spectype.recent.vs.historic
